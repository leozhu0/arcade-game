...
void Mob::update() {
  ...
  if (reload != 0)
    ...
    // easy mode
    bullets.push_back(Bullet(x, y, 0.03, -1.5707964, 0.005, false));
    bullets.push_back(Bullet(x, y, 0.03, 1.5707964, 0.005, false));
    bullets.push_back(Bullet(x, y, 0.03, 0, 0.005, false));
    bullets.push_back(Bullet(x, y, 0.03, 3.141592, 0.005, false));
    reload = 50;
  }
}
